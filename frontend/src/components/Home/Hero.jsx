...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen lg:h-screen bg-[#f4f2f0] flex items-center justify-center px-6 md:px-12 pt-24 pb-12 lg:py-0 overflow-hidden"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 items-center lg:items-end gap-8 lg:gap-4 w-full max-w-[1440px] z-10">
        ...
        <div className="order-1 lg:order-1 space-y-5 text-center lg:text-left lg:pb-8">
          <div className="space-y-2">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#2f2a26] leading-[1.1] tracking-tight">
              ...
              <span className="block">Croos</span>
            </h1>
          ...
          <h2 className="text-base md:text-lg text-[#2f2a26] font-semibold  tracking-wider flex flex-wrap justify-center lg:justify-start items-center gap-2">
            ...
            <span className="text-sm font-normal text-[#6f6256] normal-case">
        ...
        {/* CENTER IMAGE */}
        <div className="order-2 lg:order-2 flex justify-center items-end relative lg:static h-[40vh] sm:h-[50vh] lg:h-full">
        ...
        <div className="order-3 lg:order-3 space-y-6 text-center lg:text-right lg:pb-18">
          <div className="space-y-2">
