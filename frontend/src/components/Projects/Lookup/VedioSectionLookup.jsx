      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-600 text-sm md:text-base mt-3 max-w-2xl mx-auto">
            A quick walkthrough of the Lookup Gift Store Website showcasing key
            features, user interface, and workflow in action.
          </p>
        </div>
        ...
        >
          <div className="w-full md:w-[85%] lg:w-[75%] rounded-2xl overflow-hidden shadow-2xl bg-white/70 backdrop-blur-md border border-slate-200 hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)] transition-all duration-300">
            <video
              src={LookupVedio}
              controls
              className="w-full h-[230px] sm:h-[320px] md:h-[520px] object-cover"
            />
          </div>
        </motion.div>
      </div>
...
export default VedioSectionLookup;
